...
class TextHighlights:
    ...
    def message(self, text:str=None, color_type:str='xterm', fg=None, bg=None, dc=None, is_return=False, prefix=False, tag=None):
        """
        ...
        """  
        self.colorCustomization(text=text, color_type=color_type, fg=fg, bg=bg, dc=dc, prefix=prefix, tag=tag )
    ...
    def colorCustomization(self, text=None, color_type='xterm', fg=None, bg=None, dc=None, is_return=False, prefix=False, tag=None):
        if text is None:
            color = self.create_custom_color(color_type=color_type, fg=fg, bg=bg)
        
            if self.wrong_type:
                print(self.error("You have entered wrong foreground or background color w.r.t your color_type.", prefix=True, bg=None, fg=TextHighlights.MY_COLOR))
            else: 
                if is_return:
            ...
            if prefix: 
                ...
                if fg is None and bg is None:
                    color = self.create_custom_color(color_type=color_type, fg=dc, bg=bg)
                else: 
                    color = self.create_custom_color(color_type=color_type, fg=fg, bg=bg)
                
                if self.wrong_type:
                    print(self.error("You have entered wrong foreground or background color w.r.t your color_type.", prefix=True, bg=None, fg=147))
                else: 
                    if is_return:
    ...
    def error(self, text:str=None, color_type:str='xterm', fg=None, bg=None, prefix:bool=False, tag:str='ERROR'):
        self.colorCustomization(text=text, color_type=color_type, fg=fg, bg=bg, dc=9, prefix=prefix, tag=tag )

        
    def warning(self, text:str=None, color_type:str='xterm', fg=None, bg=None, prefix:bool=False):

        self.colorCustomization(text=text, color_type=color_type, fg=fg, bg=bg, dc=214, prefix=prefix, tag='WARNING' )


    def success(self, text:str=None, color_type:str='xterm', fg=None, bg=None, prefix:bool=False):
        self.colorCustomization(text=text, color_type=color_type, fg=fg, bg=bg, dc=112, prefix=prefix, tag='SUCCESS' )


    def info(self, text:str=None, color_type:str='xterm', fg=None, bg=None, prefix:bool=False):
        self.colorCustomization(text=text, color_type=color_type, fg=fg, bg=bg, dc=105, prefix=prefix, tag='INFO' )


    def highlight(self, text:str= None, color_type:str='xterm', fg=None, bg=None ):
        return self.colorCustomization(text=text, color_type=color_type, fg=fg, bg=bg, dc=165, is_return=True)
        ...
        try: 
            if hex[0] == '#':
                ...
                if len(hex) == 6:
                    ...
                    self.error(f"hex code length should be equal to 6 without # symbol.", fg=TextHighlights.MY_COLOR, bg=None, prefix=True)
            else: 
                self.error(f"hex code should start with # string: #000000", fg=TextHighlights.MY_COLOR, bg=None, prefix=True)
        except TypeError: 
            self.wrong_type = True
            self.error(f"Wrong hex code.", fg=TextHighlights.MY_COLOR, bg=None, prefix=True)
